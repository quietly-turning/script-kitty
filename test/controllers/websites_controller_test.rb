...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { institution_id: @website.institution_id, type: @website.type, url: @website.url }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { institution_id: @website.institution_id, type: @website.type, url: @website.url }
    assert_redirected_to website_path(assigns(:website))
  end
