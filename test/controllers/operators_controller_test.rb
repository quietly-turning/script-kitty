...
class OperatorsControllerTest < ActionController::TestCase
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post :create, operator: { html_representation: @operator.html_representation, name: @operator.name, sql_value: @operator.sql_value }
    end
  ...
  test "should update operator" do
    patch :update, id: @operator, operator: { html_representation: @operator.html_representation, name: @operator.name, sql_value: @operator.sql_value }
    assert_redirected_to operator_path(assigns(:operator))
  end
