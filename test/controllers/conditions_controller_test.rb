...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { column: @condition.column, complexOperator: @condition.complexOperator, operator_id: @condition.operator_id, parameter: @condition.parameter, query_id: @condition.query_id }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { column: @condition.column, complexOperator: @condition.complexOperator, operator_id: @condition.operator_id, parameter: @condition.parameter, query_id: @condition.query_id }
    assert_redirected_to condition_path(assigns(:condition))
  end
